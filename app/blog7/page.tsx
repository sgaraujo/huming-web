// app/asesoria-juridica-laboral/page.tsx
        ...
        <div className="flex min-h-screen flex-col">
            ...
            <main className="flex-1 relative z-0">
                ...
                <div className="absolute inset-0 z-[-1] bg-white dark:bg-gray-950">
                    <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,rgba(251,191,36,0.15),transparent_70%)] dark:bg-[radial-gradient(ellipse_at_top_left,rgba(251,191,36,0.1),transparent_70%)]" />
                    <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,rgba(245,158,11,0.15),transparent_70%)] dark:bg-[radial-gradient(ellipse_at_bottom_right,rgba(245,158,11,0.1),transparent_70%)]" />
                    <div
