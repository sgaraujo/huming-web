...
export default function DecorativeBackground({
  gradient = 'from-violet-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-950 dark:to-indigo-950',
  className = '',
}: {
  gradient?: string
  className?: string
  ...
  return (
    <div className={`absolute inset-0 ${className}`}>
      ...
      <div className="absolute inset-0 opacity-40 pointer-events-none" aria-hidden="true">
        <div className="absolute top-20 left-10 w-72 h-72 bg-violet-300 rounded-full mix-blend-multiply blur-xl animate-pulse" />
