            ...
            <div className="mx-auto max-w-4xl px-4 lg:px-0">
                ...
                <div className="grid divide-y border md:grid-cols-2 md:gap-4 md:divide-x md:divide-y-0">
                    <div className="flex flex-col justify-between space-y-8 p-6 sm:p-12">
                        <div>
                            <h2 className="mb-3 text-lg font-semibold">Correo</h2>
                            <Link
                                href="mailto:hello@tailus.io"
                                className="text-lg text-blue-600 hover:underline dark:text-blue-400">
                                Gerencia@huming.com.co
                            </Link>
                            <p className="mt-3 text-sm">+57 310 2365931</p>
                        </div>
                    </div>
                    <div className="flex flex-col justify-between space-y-8 p-6 sm:p-12">
                        <div>
                            <h3 className="mb-3 text-lg font-semibold">Correo</h3>
                            <Link
                                href="gerencia.administrativa@huming.com.co"
                                className="text-lg text-blue-600 hover:underline dark:text-blue-400">
