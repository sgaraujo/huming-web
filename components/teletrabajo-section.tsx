      ...
      <section className="px-6 py-16 relative">
        ...
        <div className="mx-auto max-w-5xl relative z-10">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {/* Card 1 */}
            <article className="group rounded-2xl border border-blue-100/50 bg-white/70 backdrop-blur-sm p-8 shadow-lg hover:shadow-xl hover:shadow-blue-100/30 transition-all duration-300 hover:bg-white/85 hover:-translate-y-1">
            ...
            {/* Card 2 */}
            <article className="group rounded-2xl border border-sky-100/50 bg-white/70 backdrop-blur-sm p-8 shadow-lg hover:shadow-xl hover:shadow-sky-100/30 transition-all duration-300 hover:bg-white/85 hover:-translate-y-1">
              <div className="flex items-center gap-4 mb-6">
