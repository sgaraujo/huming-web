...
export const SST_ITEMS: SSTItem[] = [
  ...
  { id: '1.1.2', ciclo: 'I. PLANEAR', estandar: 'RECURSOS (10%)', subEstandar: 'Recursos financieros, técnicos, humanos y de otra índole (4%)', descripcion: '1.1.2 Responsabilidades en el Sistema de Gestión de Seguridad y Salud en el Trabajo – SG-SST (Vigía SST, CCL, Brigadista)', valor: 0.5 },
  ...
  { id: '1.1.4', ciclo: 'I. PLANEAR', estandar: 'RECURSOS (10%)', subEstandar: 'Recursos financieros, técnicos, humanos y de otra índole (4%)', descripcion: '1.1.4 Afiliación al Sistema General de Seguridad Social (Pensión y Salud) y Riesgos Laborales (ARL)', valor: 0.5 },
  ...
  { id: '4.1.1', ciclo: 'II. HACER', estandar: 'GESTIÓN DE PELIGROS Y RIESGOS (30%)', subEstandar: 'Identificación de peligros, evaluación y valoración de riesgos (15%)', descripcion: '4.1.1 Metodología para la identificación, evaluación y valoración de peligros (Enfocado en los trabajadores y el sitio de trabajo)', valor: 4.0 },
  ...
  { id: '4.2.1', ciclo: 'II. HACER', estandar: 'GESTIÓN DE PELIGROS Y RIESGOS (30%)', subEstandar: 'Medidas de prevención y control de peligros/riesgos (15%)', descripcion: '4.2.1 Se implementan las medidas de prevención y control de peligros identificados en el sitio del trabajo y en los trabajadores', valor: 2.5 },
